...
public class MiniCamere extends Gadget {
    ...
    public MiniCamere(String brand, String culoare, String stare, int i, float pret, int stoc, int memorie,
            int greutate, int format_foto, int autonomie, String SistemOperare) {
    ...
    public String toString() {
        return super.toString() + ".Memoria de " + memorie + " gb,  cu greutatea de " + greutate
                + " g. Are formatul foto de " + format_foto + "p si o autonomie de " + autonomie
                + " minute. Sistem de operare folosit este " + SistemOperare + " . ";
    }
}