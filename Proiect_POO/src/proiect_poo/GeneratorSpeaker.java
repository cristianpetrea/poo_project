...
public class GeneratorSpeaker {
    ...
    public static Speaker[] genereazaNisteSpeaker(int n) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            Speaker speaker = new Speaker(brandSpeaker,culoareSpeaker,stareSpeaker,garantieSpeaker,pretSpeaker,stocSpeaker,onTheEarSpeaker,hasMicrofonSpeaker,operationalSystemSpeaker,frequencySpeaker,chargingTimeSpeaker);
